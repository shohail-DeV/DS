...
# Group student IDs by science mark ranges using dictionary comprehension
science_groups = {
    "Less than or equalto 30": [student["student id"] for student in student if student["Science"] <= 30],
    "Between 30 & 70": [student["student id"] for student in student if 30 < student["Science"] <= 70],
    "Greater than 70": [student["student id"] for student in student if student["Science"] > 70],
}

print("Science Mark Groups:")
for group_name, student_ids in science_groups.items():
    print(f"{group_name}: {student_ids}")