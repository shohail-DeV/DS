...
# Extract Math and Computer Science marks
math_marks = [student["Math"] for student in student]
cs_marks = [student["Computer Science"] for student in student]

# Calculate correlation using the statistics library
correlation = statistics.correlation(math_marks, cs_marks)

print("\nCorrelation (Computer Science, Math):", correlation)